...
(function (global) {
  ...
  function render() {
    ...
    if (sw.weaknesses.length) {
      ...
      var focusText = {
        english: "Подтяните английский — добавьте актуальный балл IELTS или TOEFL в анкете, если сдавали, или запишитесь на подготовку.",
        sat: "Добавьте балл SAT в анкете, если сдавали — он напрямую участвует в подборе вузов США.",
