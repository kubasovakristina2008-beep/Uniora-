...
(function (global) {
  ...
  var UI = {
    ...
    recommendations: {
      ...
      matchPercentSuffix: { ru: "% совпадение", en: "% match" },
      target: { ru: "🎯 Цель", en: "🎯 Target" },
      early: { ru: "Ранняя:", en: "Early:" },
      main: { ru: "Основная:", en: "Main:" },
      deadlineNote: { ru: "(данные прошлого цикла подачи, уточняйте на сайте)", en: "(data from last cycle — verify on the university's website)" },
      ranking: { ru: "Рейтинг: #{country} в стране, #{world} в мире (ориентировочно)", en: "Ranking: #{country} in country, #{world} worldwide (approximate)" },
      ...
      acceptanceRateFact: { ru: "По данным прошлого цикла вуз принимал ориентировочно {rate}% абитуриентов (демо-данные, не гарантия поступления).", en: "In the last cycle, the university admitted roughly {rate}% of applicants (demo data, not a guarantee of admission)." }
    },
    compare: {
      ...
      acceptanceRate: { ru: "Проходимость (прошлый цикл, ориентировочно)", en: "Acceptance rate (last cycle, approximate)" },
      ...
      lastCycleData: { ru: "данные прошлого цикла", en: "last cycle data" },
      ...
      notPublished: { ru: "Не публикуется в источнике", en: "Not published in the source" },
      scholarship: { ru: "Стипендия", en: "Scholarship" },
      noData: { ru: "Нет данных", en: "No data" },
      dormitory: { ru: "Общежитие", en: "Dormitory" },
      ranking: { ru: "Рейтинг", en: "Ranking" },
      rankingValue: { ru: "#{country} в стране / #{world} в мире (ориентировочно)", en: "#{country} in country / #{world} worldwide (approximate)" },
    ...
    roadmap: {
      ...
      journeyDeadlineText: { ru: "Дедлайн подачи: {deadline} (данные прошлого цикла, уточняйте на сайте).", en: "Submission deadline: {deadline} (last cycle data, verify on the website)." },
      ...
      printLastCycle: { ru: "(прошлый цикл)", en: "(last cycle)" },
